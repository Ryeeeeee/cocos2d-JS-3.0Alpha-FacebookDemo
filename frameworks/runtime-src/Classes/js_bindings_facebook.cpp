...
void register_facebook_js(JSContext* cx, JSObject* global){
	...
	JS_DefineFunction(cx, global, "login", JSB_Facebook_login, 2, JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineFunction(cx, global, "logout", JSB_Facebook_logout, 1, JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineFunction(cx, global, "getLoginStatus", JSB_Facebook_getLoginStatus, 2, JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineFunction(cx, global, "api", JSB_Facebook_api, 4, JSPROP_READONLY | JSPROP_PERMANENT);
	JS_DefineFunction(cx, global, "ui", JSB_Facebook_ui, 3, JSPROP_READONLY | JSPROP_PERMANENT);
}